  ...
  return (
    <div>
        <div className="d-flex flex-column flex-root" id="kt_app_root"
         style={{ backgroundImage: `url('assets/media/auth/bg10-dark.jpeg')`}}
         >
			
			{/* <style>body { background-image: ; } [data-bs-theme="dark"] body { background-image: url('assets/media/auth/bg10-dark.jpeg'); }</style> */}
			...
			<div className="d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div className="d-flex flex-lg-row-fluid">
					...
					<div className="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
						...
						<span  className="opacity-75-hover text-primary me-1">the blogger</span>introduces a person they’ve interviewed
						<br />and provides some background information about
						<span  className="opacity-75-hover text-primary me-1">the interviewee</span>and their
					...
					<div className="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
						...
						<div className="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
							...
							<div className="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
								...
								<form className="form w-100" id="kt_sign_in_form" data-kt-redirect-url="../../demo39/dist/index.html" action="#">
									...
									<div className="row g-3 mb-9">
										...
										<div className="col-md-6">
											...
											<span className="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
											<img alt="Logo" src="assets/media/svg/brand-logos/google-icon.svg" className="h-15px me-3" />Sign in with Google</span>
										...
										<div className="col-md-6">
											...
											<img alt="Logo" src="assets/media/svg/brand-logos/apple-black-dark.svg" className="theme-dark-show h-15px me-3" />Sign in with Apple</span>
									...
									<div className="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
										...
										<a href="../../demo39/dist/authentication/layouts/overlay/reset-password.html" className="link-primary">Forgot Password ?</a>
									...
									<a href="../../demo39/dist/authentication/layouts/overlay/sign-up.html" className="link-primary">Sign up</a></div> */}
