...
import error from "../../_metronic/assets/media/auth/404-error-dark.png";
import topGreen from "../../_metronic/assets/media/svg/shapes/top-green.png";
import sigma from "../../_metronic/assets/media/illustrations/sigma-1/17-dark.png";
import vuejs from "../../_metronic/assets/media/svg/brand-logos/vue-9.svg";
import bootstrap from "../../_metronic/assets/media/svg/brand-logos/bootstrap5.svg";
import angular from "../../_metronic/assets/media/svg/brand-logos/angular-icon.svg";
import spring from "../../_metronic/assets/media/svg/brand-logos/spring-3.svg";
import typescript from "../../_metronic/assets/media/svg/brand-logos/typescript-1.svg";
                                    ...
                                    <div data-kt-menu-trigger="click" className="menu-item here show menu-accordion">
                                        ...
                                        <div className="menu-sub menu-sub-accordion">
                                            ...
                                            <div className="menu-item">
                                                ...
                                                <a className="menu-link active" href="../../demo39/dist/dashboards/online-courses.html">
                                                    <span className="menu-bullet">
                                                        <span className="bullet bullet-dot"></span>
                                                    </span>
