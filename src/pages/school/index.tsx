					...
					<div className="d-flex flex-stack flex-grow-1">
						...
						<div className="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
							...
							<div className="app-navbar-item ms-2 ms-lg-6">
								...
								<div className="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"  id="kt_menu_notifications">
							...
							<div className="app-navbar-item ms-2 ms-lg-6">
								...
								<div className="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" >
							...
							<div className="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
								...
								<div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" >
									...
									<div className="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
										...
										<div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-gray-500 menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px"  data-kt-element="theme-mode-menu">
				...
				<div className="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					...
					<div id="kt_app_sidebar" className="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						...
						<div id="kt_app_sidebar_wrapper" className="app-sidebar-wrapper hover-scroll-y my-5 my-lg-2" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_header" data-kt-scroll-wrappers="#kt_app_sidebar_wrapper" data-kt-scroll-offset="5px">
							...
							<div id="#kt_app_sidebar_menu"  data-kt-menu-expand="false" className="app-sidebar-menu-primary menu menu-column menu-rounded menu-sub-indention menu-state-bullet-primary px-6 mb-5">
									...
									<div className="menu-sub menu-sub-accordion">
										...
										<div className="menu-inner flex-column collapse show" id="kt_app_sidebar_menu_dashboards_collapse">
											...
											<div className="menu-item">
												...
												<a className="menu-link active" href="../../demo39/dist/dashboards/school.html">
													<span className="menu-bullet">
														<span className="bullet bullet-dot"></span>
													</span>
															...
															<div className="table-responsive">
																...
																<table className="table align-middle">
																	...
																	<tbody>
																		...
																		<tr>
																			<td className="bg-light rounded text-gray-600 fs-8 fw-bold px-3 py-2 w-100" >Break 205min</td>
																		</tr>
																		<tr>
												...
												<div className="card-body p-0">
													...
													<div className="carousel-inner">
														...
														<div className="carousel-item active show">
															...
															<div className="d-flex align-items-center w-100 px-8">
																...
																<div className="progress h-6px w-100 mx-3 bg-light-primary">
																	{/* <div className="progress-bar bg-primary" role="progressbar" aria-valuenow="62" aria-valuemin="0" aria-valuemax="100"></div> */}
																</div>
															...
															<div id="kt_sliders_widget_3_chart_1" className="min-h-auto ps-4 pe-6"></div>
														...
														<div className="carousel-item">
															...
															{/* <div id="kt_sliders_widget_3_chart_2" className="min-h-auto ps-4 pe-6"></div> */}
					...
					<div className="modal-body py-lg-10 px-lg-10">
						...
						<div className="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="kt_modal_create_app_stepper">
									...
									<div className="stepper-item current" data-kt-stepper-element="nav">
										...
										<div className="stepper-wrapper">
											...
											<div className="stepper-icon w-40px h-40px">
												<i className="ki-outline ki-check stepper-check fs-2"></i>
							...
							<div className="flex-row-fluid py-lg-5 px-lg-15">
								...
								<form className="form"  id="kt_modal_create_app_form">
											...
											<div className="fv-row">
												...
												<label className="d-flex flex-stack cursor-pointer mb-5">
													...
													<span className="d-flex align-items-center me-2">
														...
														<span className="symbol symbol-50px me-6">
															<span className="symbol-label bg-light-warning">
																<i className="ki-outline ki-html fs-2x text-warning"></i>
															</span>
														</span>
													...
													<span className="form-check form-check-custom form-check-solid">
														<input className="form-check-input" type="radio" name="framework" value="1" />
													</span>
												...
												<label className="d-flex flex-stack cursor-pointer mb-5">
													...
													<span className="d-flex align-items-center me-2">
														...
														<span className="symbol symbol-50px me-6">
															<span className="symbol-label bg-light-success">
																<i className="ki-outline ki-react fs-2x text-success"></i>
															</span>
														</span>
												...
												<label className="d-flex flex-stack cursor-pointer mb-5">
													...
													<span className="d-flex align-items-center me-2">
														...
														<span className="symbol symbol-50px me-6">
															<span className="symbol-label bg-light-danger">
																<i className="ki-outline ki-angular fs-2x text-danger"></i>
															</span>
														</span>
												...
												<label className="d-flex flex-stack cursor-pointer">
													...
													<span className="d-flex align-items-center me-2">
														...
														<span className="symbol symbol-50px me-6">
															<span className="symbol-label bg-light-primary">
																<i className="ki-outline ki-vue fs-2x text-primary"></i>
															</span>
														</span>
											...
											<div className="fv-row">
												...
												<label className="d-flex flex-stack cursor-pointer mb-5">
													...
													<span className="d-flex align-items-center me-2">
														...
														<span className="symbol symbol-50px me-6">
															<span className="symbol-label bg-light-success">
																<i className="ki-outline ki-note text-success fs-2x"></i>
															</span>
														</span>
													...
													<span className="form-check form-check-custom form-check-solid">
														<input className="form-check-input" type="radio" name="dbengine" value="1" />
													</span>
												...
												<label className="d-flex flex-stack cursor-pointer mb-5">
													...
													<span className="d-flex align-items-center me-2">
														...
														<span className="symbol symbol-50px me-6">
															<span className="symbol-label bg-light-danger">
																<i className="ki-outline ki-google text-danger fs-2x"></i>
															</span>
														</span>
												...
												<label className="d-flex flex-stack cursor-pointer">
													...
													<span className="d-flex align-items-center me-2">
														...
														<span className="symbol symbol-50px me-6">
															<span className="symbol-label bg-light-warning">
																<i className="ki-outline ki-microsoft text-warning fs-2x"></i>
															</span>
														</span>
											...
											<div className="row mb-10">
												...
												<div className="col-md-4 fv-row">
													...
													<div className="position-relative">
														...
														<input type="text" className="form-control form-control-solid" placeholder="CVV" name="card_cvv" />
